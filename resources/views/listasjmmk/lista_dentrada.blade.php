         	...
         	<div class="table-responsive">
			    ...
			    @endif
      			...
      			<table class="table table-bordered">
				    ...
				    <tbody>
				    @foreach($listadentrada as $value)
				        <tr>
				            ...
				            <td>{{$value->unombre}}<br>{{$value->equipo}}</td>
				            <td><a href="{{route('profileconsultorio',$value->idpersona)}}" class="btn btn-success">Atender Caso</a></td>
				        </tr>
				    @endforeach()	
