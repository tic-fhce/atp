                    ...
                    <div class="col-md-8">
                      ...
                      <div class="alert alert-success" role="alert">
                        @if($enatencion=="")
                          Caso sin Derivacion
                        @else
                          Resibido por {{$enatencion->nombrederivado}}
                        @endif
                      </div>
                      <div class="bottom">
            ...
            <div class="col-md-8">
              <div class="block-web full">
                ...
                <ul class="nav nav-tabs nav-justified nav_bg">
                  ...
                  @if($datos->idequipo!=3 and $datos->idequipo!=2)                  
                  ...
                  <div class="tab-pane" id="edit-profile">
                    <div class="user-profile-content">
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm-8">
                              <select name="equipo">
                                ...
                                @foreach ($equipo as $value)
                                    @if($value->id!= 1 and $value->id!= 5 and $value->id!= 6 and $value->id!=4)
                        ...
                        @else
                          <form action="{{route('UpdateDeribarR')}}" class="form-horizontal row-border" method="POST">
                          @csrf
                            <input type="hidden" name="idderivar" value="{{$derivar->id}}">
                            <div class="form-group">
                              <label class="col-sm-4 control-label">Derivar a :</label>
                            ...
                            <input type="submit" value="Registar Derivacion">
                          </form>
                        @endif
