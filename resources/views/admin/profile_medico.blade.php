                    ...
                    <div class="user-profile-content">
                      <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="edad" value="{{$persona->edad}}" maxlength="3" required="true" maxlength="2">
                            </div>
                          </div><!--/form-group--> 
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <select name="sexo" required="true">
                                <option value="{{$persona->sexo}}">{{$cliente->sexo}}</option>
                            ...
                            <div class="col-sm-8">
                              <select name="equipo">
                                ...
                                @foreach ($equipo as $value)
                                    @if($value->id!= 1 and $value->id!= 5 and $value->id!= 6)
