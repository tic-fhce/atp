                            ...
                            <div class="col-sm-8">
                              <select name="equipo">
                                ...
                                @foreach ($equipo as $value)
                                  @if($value->id!=1  and $value->id!=6 and $value->id!=5)                                    
